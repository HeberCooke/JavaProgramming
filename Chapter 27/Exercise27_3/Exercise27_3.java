public class Exercise27_3 {
	...
	public static void main(String[] args) {
		...
		map.put(5, 5);
		map.put(6, 6);
		System.out.println("Map entries  " + map.toString());
		System.out.println("map size is " + map.size);
		System.out.println("map capacity is " + map.capacity);
		System.out.println("Map  get  3 is : " + map.get(3));
		System.out.println("Is key 2 in the map? " + map.containsKey(2));
		map.remove(2);
		System.out.println("map removed 2 ");
		System.out.println("Is key 2 in the map? " + map.containsKey(2));
		System.out.println("Map entries  " + map.toString());
	}
	...
	static class MyHashMap<K, V> implements MyMap<K, V> {
		...
		public V put(K key, V value) {
			...
			size++; // Increase size
			// System.out.println("Entry in map put is --> Key "+ key + " Value "+
			// value);//for tests
			return value;
		}
